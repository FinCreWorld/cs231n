...
def affine_norm_relu_forward(x, w, b, gamma, beta, bn_param, normalization):
    """Convenience layer that performs an affine-norm transform followed by a relu.

    Inputs:
    - x: Input to the affine layer
    - w, b: Weights for the affine layer
    - bn_param: Params for the normalization layer
    - nomalization: What type of normalization the network should use. Valid values
